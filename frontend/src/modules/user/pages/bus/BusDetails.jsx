  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#FFF1F2_0%,#FDF2F8_15%,#F8FAFC_100%)] max-w-lg mx-auto font-sans pb-32">
      ...
      <div className="px-5 pt-5 space-y-4">
         ...
         {/* Summary Banner */}
         <div className="bg-rose-600 rounded-[24px] p-5 text-white shadow-[0_8px_24px_rgba(225,29,72,0.25)] relative overflow-hidden">
             <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-bl-full pointer-events-none" />
             <div className="flex justify-between items-start relative z-10">
                <div>
                   <p className="text-[10px] font-black text-rose-200 uppercase tracking-widest mb-1">{date} · {bus.departure}</p>
                   <h3 className="text-[18px] font-black leading-tight">{bus.operator}</h3>
                   <p className="text-[12px] font-bold text-rose-100 mt-1">{bus.type}</p>
                </div>
                <div className="text-right">
                   <p className="text-[10px] font-black text-rose-200 uppercase tracking-widest mb-1">Seats</p>
         ...
         <div className="bg-white/90 rounded-[24px] p-5 shadow-[0_4px_14px_rgba(15,23,42,0.04)] border border-white/80 space-y-4">
             ...
             <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3 focus-within:border-rose-300 transition-colors">
             ...
             <div className="flex gap-3">
                <div className="flex-1 space-y-1.5">
                   ...
                   <input type="number" placeholder="25" value={age} onChange={e => setAge(e.target.value)}
                      className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3 text-[14px] font-bold text-slate-900 focus:outline-none focus:border-rose-300 transition-colors" />
                </div>
