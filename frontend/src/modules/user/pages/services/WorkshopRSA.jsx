  ...
  return (
    <div className="min-h-screen bg-[#F6F8F7] max-w-lg mx-auto font-sans pb-10">
      ...
      <div className="px-5 pt-5 space-y-5">
        ...
        <section>
          <h2 className="ml-1 text-[16px] font-black tracking-tight text-gray-900">
            Popular Help
          </h2>
            ...
            {helpItems.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  <div
                    className={`inline-flex rounded-2xl border p-3 ${item.tone}`}>
                    <Icon size={20} strokeWidth={2.5} />
                  </div>
                  <h3 className="mt-4 text-[15px] font-black tracking-tight text-gray-900">
                    {item.title}
                  </h3>
