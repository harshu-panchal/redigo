...
const menuItems = [
  ...
  },
  {
    icon: Wrench,
    title: "Workshop & RSA",
    sub: "Roadside assistance on demand",
    path: "/services/workshop-rsa",
    bg: "bg-amber-50",
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg mx-auto font-sans pb-28 relative overflow-hidden">
      ...
      <div className="px-5 space-y-2">
        <p className="text-[9px] font-black uppercase tracking-[0.26em] text-slate-400 mb-1 ml-1">
          Settings
        </p>
        ...
        <motion.div
          ...
          {menuItems.map(({ icon: Icon, title, sub, path, bg, color }, i) => (
            <motion.button
              ...
              <div
                className={`w-8 h-8 rounded-[10px] flex items-center justify-center shrink-0 ${bg}`}>
