  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] max-w-lg mx-auto flex flex-col font-sans relative">
      <header className="bg-white px-5 py-8 flex items-center gap-6 border-b border-gray-50 shadow-sm sticky top-0 z-20">
        ...
        <div>
          <h1 className="text-[20px] font-extrabold text-gray-900 tracking-tight leading-none uppercase tracking-widest text-xs opacity-50 mb-2">
            Settings
          </h1>
          <h2 className="text-[17px] font-black text-gray-900 leading-none">
            Your Profile
          </h2>
        </div>
      </header>
      ...
      <div className="flex-1 p-5 space-y-10 overflow-y-auto no-scrollbar">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <label className="text-[12px] font-black text-gray-400 ml-1 uppercase tracking-widest">
              Full Name
            </label>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 bg-gray-50/50 border border-gray-50 rounded-[28px] p-4 px-5 shadow-sm opacity-80 cursor-not-allowed">
              ...
              <div className="bg-green-100 text-green-700 text-[9px] font-black px-2 py-0.5 rounded uppercase tracking-widest">
                Verified
              </div>
            </div>
          </div>
