    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg mx-auto flex flex-col font-sans pb-24 relative overflow-x-hidden">
              ...
              {isSuccess ? (
                ...
                <div className="space-y-8">
                  <div className="relative group">
                    <span className="absolute left-6 top-1/2 -translate-y-1/2 text-2xl font-black text-gray-400 group-focus-within:text-orange-500 transition-colors">
                      â‚¹
                    </span>
                    <input
                      type="number"
              ...
              {isSendSuccess ? (
                ...
                <div className="space-y-5">
                  ...
                  <div className="relative">
                    <span className="absolute left-6 top-1/2 -translate-y-1/2 text-xl font-black text-gray-400">
                      ₹
                    </span>
                    <input
                      type="number"
      ...
      <header className="sticky top-0 z-30">
        <div className="bg-white/70 backdrop-blur-md border-b border-white/70 shadow-[0_10px_20px_rgba(15,23,42,0.05)]">
          <div className="px-5 py-4 flex items-center gap-3">
            ...
            <h1 className="text-[19px] font-black text-gray-900 tracking-tight">
              My Wallet
            </h1>
          </div>
        </div>
        ...
        <motion.div
          ...
          <div className="relative z-10 flex flex-col gap-8">
            <div className="space-y-1">
              <p className="text-white/30 font-black uppercase tracking-[0.2em] text-[8px]">
                Current Liquidity
              </p>
              <motion.h2
            ...
            <div className="flex items-center gap-3">
              <motion.button
                ...
                <span
                  aria-hidden="true"
                  className="absolute inset-0 bg-orange-500/55"
                />
                <motion.span
                  aria-hidden="true"
      ...
      <div className="px-5 mt-8 grid grid-cols-3 gap-3">
        <div
          ...
          className="bg-white border border-gray-100 rounded-[28px] p-5 flex flex-col items-center justify-center gap-3 shadow-sm cursor-pointer active:scale-95 transition-all hover:border-blue-100 group">
        ...
        <div
          ...
          className="bg-white border border-gray-100 rounded-[28px] p-5 flex flex-col items-center justify-center gap-3 shadow-sm cursor-pointer active:scale-95 transition-all hover:border-green-100 group">
      ...
      <div className="px-5 mt-8">
        <div
          ...
          <div className="flex-1">
            <h4 className="text-[15px] font-black text-gray-900 tracking-tight">
              Refer & Earn â‚¹50
            </h4>
          ...
          <ArrowLeft
            size={20}
            className="text-orange-200 rotate-180 group-hover:text-orange-500 transition-colors"
          />
        </div>
      </div>
      ...
      <div className="px-5 mt-10">
        ...
        <div className="bg-white rounded-[36px] border border-gray-50 shadow-sm p-3 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4 p-4 rounded-[28px] hover:bg-gray-50 cursor-pointer transition-all active:scale-[0.99] group">
            ...
            <div className="text-right shrink-0">
              <h4 className="text-[16px] font-black text-emerald-600 tracking-tight">
                +â‚¹1,000
              </h4>
              <div className="flex items-center gap-1 justify-end mt-0.5">
