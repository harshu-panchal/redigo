...
const RideDetail = () => {
  ...
  const handleShare = () => {
    const text = `My Namma Trip #RDG${id || "8231"} — Pipaliyahana → Vijay Nagar Square | ₹22.00`;
    if (navigator.share) {
      navigator.share({ title: "Namma Trip", text }).catch(() => {});
    } else {
    ...
    <div className="min-h-screen bg-[#FDFDFD] max-w-lg mx-auto flex flex-col font-sans relative">
      ...
      <header className="bg-white p-5 flex items-center justify-between border-b border-gray-50 shadow-sm sticky top-0 z-20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[17px] font-black text-gray-900 leading-none">
              Trip ID: #RDG{id || "8231"}
            </h1>
      ...
      <div className="flex-1 p-5 space-y-8 overflow-y-auto no-scrollbar">
        ...
        <div className="relative pl-8 space-y-6">
          ...
          <div className="relative">
            ...
            <h4 className="text-[12px] font-black text-gray-400 uppercase tracking-widest mb-1">
              Pickup
            </h4>
            <p className="text-[15px] font-black text-gray-800 leading-tight">
              Pipl, Indore, Madhya Pradesh
            </p>
        ...
        <div className="flex items-center justify-between p-5 bg-orange-50/50 rounded-[28px] border border-orange-50">
          <div className="flex items-center gap-4">
            <div className="w-11 h-11 bg-white rounded-2xl p-0.5 overflow-hidden border border-orange-100">
              <img
                src="https://ui-avatars.com/api/?name=Kishan+Kumawat&background=f0f0f0&color=000"
          ...
          <button className="bg-white px-4 py-2 rounded-full text-[12px] font-black text-gray-900 border border-orange-100 active:scale-95 transition-all">
            Support
          </button>
        </div>
      </div>
