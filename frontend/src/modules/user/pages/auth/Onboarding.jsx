...
const Onboarding = () => {
  ...
  return (
    <div
      className="min-h-screen max-w-lg mx-auto font-sans flex flex-col overflow-hidden relative"
      style={{
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 relative z-10">
        <AnimatePresence mode="wait" custom={direction}>
          <motion.div
            ...
            <p className="text-[14px] font-bold text-white/75 leading-relaxed max-w-[280px]">
              {slide.body}
            </p>
          </motion.div>
        </AnimatePresence>
